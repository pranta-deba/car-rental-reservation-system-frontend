    ...
    return (
        <nav className="p-4 shadow">
            <div className="container mx-auto flex justify-between items-center">
                ...
                <ul
                    className={`md:flex md:space-x-6 absolute md:static w-full left-0 md:w-auto bg-white shadow-md md:shadow-none md:flex-row flex-col items-center p-4 md:p-0 transition-all ease-in-out duration-300 ${isOpen ? "top-16" : "top-[-400px] "}`}
                >
                    {navLinks}
                </ul>
            </div>
