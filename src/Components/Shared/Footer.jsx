        ...
        <footer className="px-4  dark:bg-gray-100 dark:text-gray-800">
            <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                <div className="lg:w-1/3">
                    ...
                    <p>At PXRent, we prioritize your comfort and convenience by offering top-quality vehicles, affordable pricing, and exceptional customer service. Whether you're traveling for business or leisure, we ensure a smooth and hassle-free rental experience.</p>
                </div>
                <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
                    <div className="space-y-3">
                        <h3 className="tracking-wide uppercase dark:text-gray-900">Our Locations</h3>
                        <ul className="space-y-1">
                            <li>
                                +123 456 7890
                            </li>
                            <li>
                                support@pxrental.com
                            </li>
                            <li>
